...
testthat::test_that("schtask_create_minute validates every parameter", {
  testthat::expect_error(
    schtask_create_minute("Task", "C:\\test.exe", every = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_minute("Task", "C:\\test.exe", every = 1440),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_minute("Task", "C:\\test.exe", every = -1),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_hourly validates every parameter", {
  testthat::expect_error(
    schtask_create_hourly("Task", "C:\\test.exe", every = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_hourly("Task", "C:\\test.exe", every = 24),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_daily validates every parameter", {
  testthat::expect_error(
    schtask_create_daily("Task", "C:\\test.exe", every = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_daily("Task", "C:\\test.exe", every = 366),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_weekly validates every parameter", {
  testthat::expect_error(
    schtask_create_weekly("Task", "C:\\test.exe", every = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_weekly("Task", "C:\\test.exe", every = 53),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_weekly validates days parameter", {
  testthat::expect_error(
    schtask_create_weekly("Task", "C:\\test.exe", days = "INVALID"),
    "Invalid day of week"
  )
})
...
testthat::test_that("schtask_create_monthly validates numeric modifier", {
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = 13),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_monthly validates character modifier", {
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = "INVALID"),
    "Invalid"
  )
})
...
testthat::test_that("schtask_create_monthly requires day for week modifiers", {
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = "FIRST"),
    "day.*parameter is required"
  )
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = "SECOND"),
    "day.*parameter is required"
  )
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = "LAST"),
    "day.*parameter is required"
  )
})
...
testthat::test_that("schtask_create_monthly validates day range for numeric modifier", {
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = 1, day = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", modifier = 1, day = 32),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_monthly validates months parameter", {
  testthat::expect_error(
    schtask_create_monthly("Task", "C:\\test.exe", months = "INVALID"),
    "Invalid month"
  )
})
...
testthat::test_that("schtask_create_once requires start_time", {
  testthat::expect_error(
    schtask_create_once("Task", "C:\\test.exe"),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_once validates start_time format", {
  testthat::expect_error(
    schtask_create_once("Task", "C:\\test.exe", start_time = "invalid"),
    "Invalid time format"
  )
})
...
testthat::test_that("schtask_create_on_idle validates idle_time parameter", {
  testthat::expect_error(
    schtask_create_on_idle("Task", "C:\\test.exe", idle_time = 0),
    class = "simpleError"
  )
  testthat::expect_error(
    schtask_create_on_idle("Task", "C:\\test.exe", idle_time = 1000),
    class = "simpleError"
  )
})
...
testthat::test_that("schtask_create_on_idle requires idle_time", {
  testthat::expect_error(
    schtask_create_on_idle("Task", "C:\\test.exe"),
    class = "simpleError"
  )
})
...
testthat::test_that("all create functions validate task_name", {
  ...
  testthat::expect_error(
    schtask_create_minute("Task<Name", "C:\\test.exe"),
    "invalid characters"
  )
  testthat::expect_error(
    schtask_create_hourly("Task>Name", "C:\\test.exe"),
    "invalid characters"
  )
  testthat::expect_error(
    schtask_create_daily("Task:Name", "C:\\test.exe"),
    "invalid characters"
  )
  testthat::expect_error(
    schtask_create_weekly("Task|Name", "C:\\test.exe"),
    "invalid characters"
  )
  testthat::expect_error(
    schtask_create_monthly("Task?Name", "C:\\test.exe"),
    "invalid characters"
  )
  testthat::expect_error(
    schtask_create_once("Task*Name", "C:\\test.exe", start_time = "09:00"),
    "invalid characters"
  )
})
